...
img0 = cv2.imread('c:/img/people.jpg', cv2.IMREAD_GRAYSCALE)
img1 = cv2.imread('c:/img/face.jpg', cv2.IMREAD_GRAYSCALE)
...
img = cv2.imread('c:/img/Lena.png', cv2.IMREAD_GRAYSCALE)
