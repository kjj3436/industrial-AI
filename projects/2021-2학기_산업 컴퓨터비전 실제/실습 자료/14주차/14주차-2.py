...
haar_face_cascade = cv2. CascadeClassifier('c:/img/haarcascade_frontalface_default.xml')
detect_faces('c:/img/faces.mp4', haar_face_cascade, 'Haar cascade face detector') 

lbp_face_cascade = cv2.CascadeClassifier()
lbp_face_cascade.load('c:/img/lbpcascade_frontalface.xml')
